...
var Speaker, StreamPlayer, audioOptions, events, fs, lame, loadNextSong, mm, request, self,
...
StreamPlayer = (function(superClass) {
  ...
  StreamPlayer.prototype.play = function(seconds) {
    if (this.playing) {
    ...
    if (this.currentSong !== null) {
      ...
      this.getStream(this.queue[0], seconds, this.playStream);
      this.playing = true;
      this.queue.shift();
  ...
  StreamPlayer.prototype.getStream = function(url, seconds, callback) {
    if (seconds == null) {
      seconds = 0;
    }
